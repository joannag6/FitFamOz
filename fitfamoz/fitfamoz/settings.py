"""
Django settings for fitfamoz project.
...
SECRET_KEY = 'zfpf_2b=ctlsps5scy-0(a@mbeu#=sv$j2*e5_&s1lh^2$1&8y'
...
WSGI_APPLICATION = 'fitfamoz.wsgi.application'
